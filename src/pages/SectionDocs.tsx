...
function PrivacyDoc() {
  return (
    <div className="space-y-5 text-sm text-foreground leading-relaxed">
      ...
      <section>
        ...
        <div className="bg-secondary/50 rounded-xl border border-border p-4 space-y-1.5 text-sm">
          {[
            ...
            <div key={i} className="flex justify-between border-b border-border/40 pb-1.5 last:border-0 last:pb-0">
      ...
      <section>
        <h2 className="font-heading font-bold text-base text-foreground mb-2">2. Категории обрабатываемых персональных данных</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="bg-secondary/70">
                <th className="text-left p-2.5 border border-border font-semibold">Категория данных</th>
            ...
            <tbody>
              {[
                ["Идентификационные", "ФИО, email, телефон, ИНН (для юр. лиц)", "Регистрация и идентификация"],
                ["Платёжные", "Данные банковской карты (токенизированные), история платежей", "Исполнение договора, возвраты"],
                ["Профессиональные", "Наименование хозяйства, регион, культуры, площади полей", "Персонализация аналитики"],
                ["Технические", "IP-адрес, cookie, данные браузера, журналы действий", "Безопасность, улучшение сервиса"],
