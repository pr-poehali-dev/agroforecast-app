...
const SECTION_TITLES: Record<string, { label: string; desc: string; seoTitle: string; seoDesc: string }> = {
  ...
  forecasts:    { label: "Прогнозы цен",        desc: "Цены и урожайность культур",             seoTitle: "Прогнозы цен на зерно 2026 — АгроПорт",                                                        seoDesc: "AI-прогнозы цен на пшеницу, подсолнечник, кукурузу и ячмень. Актуальные котировки НТБ." },
  ...
  "ai-model":   { label: "AI-модель",           desc: "ARIMA + LSTM прогнозирование",          seoTitle: "AI-модель прогнозирования цен на зерно — ARIMA+LSTM | АгроПорт",                             seoDesc: "Машинное обучение для прогноза цен на агрорынке. Аналитические модели прогнозирования. Настраиваемые параметры и горизонт прогноза." },
